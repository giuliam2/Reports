...
<br><br>
  ...
  <h1><span style="font-family:Georgia,serif; color:black">Theatres in the UK and classical music</span></h1>
    <p>Introduction 
The following report details the methodology and tools employed in a project aimed at creating a comprehensive story about the changing face of rock music beyond gender boundaries and throughout different time periods and regions. The primary data source for this project was Wikidata, a collaborative knowledge base that provided a wealth of information on artists, genres, and related entities within the rock music domain. Using the power of data and queries, this project wanted to analyze and present a story analysing the origin and development of rock music and highlighting the characteristics of two examples of rock bands. 
